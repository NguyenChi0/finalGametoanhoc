...
INSERT INTO `achievements` VALUES (1,'Top1-Week','Người hoạt động tích cực nhất tuần','top1.png'),(2,'Top2-Week','Người hoạt động tích cực thứ hai tuần','top2.png'),(3,'Top3-Week','Người hoạt động tích cực thứ ba tuần','top3.png'),(4,'Top4-Week','Người hoạt động tích cực','top4.png'),(5,'Top5-Week','Người hoạt động tích cực ','top5.png');
...
CREATE TABLE `contests` (
  ...
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '0 đã kết thúc, 1 đã lên lịch, 2 đang kích hoạt',
...
INSERT INTO `music` VALUES (1,'Nhạc 1','/music/nhac1.mp3'),(2,'Nhạc 2','/music/nhac2.mp3'),(3,'Nhạc 3','/music/nhac3.mp3'),(4,'Nhạc 4','/music/nhac4.mp3'),(5,'Nhạc 5','/music/nhac5.mp3'),(6,'Nhạc 6','/music/nhac6.mp3'),(7,'Nhạc 7','/music/nhac7.mp3'),(8,'Nhạc 8','/music/nhac8.mp3');
...
CREATE TABLE `user_contests` (
  ...
  CONSTRAINT `user_contests_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_contests_ibfk_2` FOREIGN KEY (`contest_id`) REFERENCES `contests` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'123',NULL,'$2b$08$VK9olrmdM2Da6Wg7xO6Ld.6.THDUBOup8EqAARb4TY0DGz/SlZUkK','2025-10-13 10:17:24',667,NULL,679,0,'minhanhphung91@gmail.com','+84 0945932004'),(5,'username01',NULL,'$2b$08$KeZYBISLmGf53cJ7vWpZTuv8FbSL4sp80oF./xIAZMKX/qooUdHOq','2025-10-14 15:35:27',22,NULL,16,0,NULL,NULL),(7,'username02',NULL,'$2b$08$5Dl2cncIiqRmWdcjVgec6.ElGfMjx0IGvAN5Mymf7OkQOa33k/klO','2025-10-14 15:35:36',30,NULL,10,0,NULL,NULL),(8,'username03',NULL,'$2b$08$33dZuvYdY2YXgnhWKCnbyuhFeBPc9LxcPufnH1i7UGRA26XMogfsy','2025-10-14 15:36:01',500,NULL,17,0,NULL,NULL),(9,'username04',NULL,'$2b$08$vMt87Ug01ASbYBdMPISnbuICazlS7h9yrT/Pf7V5XPeZSer32B.7G','2025-10-14 15:36:04',0,NULL,NULL,0,NULL,NULL),(10,'username05',NULL,'$2b$08$pmmMfJSoRv5HO1/6B6gVhusoQJNCjKPA8bcboGcxlJZgqDKuv8Lia','2025-10-14 15:36:06',8,NULL,8,0,NULL,NULL),(11,'username06',NULL,'$2b$08$.8pp8UeOoFLYLYV5xPQ5.OiYAPS6a6pz5S8XXVMZWSp3awR6tnqoC','2025-10-14 15:36:09',0,NULL,NULL,0,NULL,NULL),(12,'username07',NULL,'$2b$08$9PBFeK.g7Z0PkgZd4zq9NeAxHYJ/EN33RPNfpwHn94RTdZH45lB5u','2025-10-14 15:36:11',0,NULL,NULL,0,NULL,NULL),(13,'username08',NULL,'$2b$08$fVFNEzhaigD5OtqSIUaBvO0rCdN326R1p9VigHz97kQQgWPvdSS72','2025-10-14 15:36:14',0,NULL,NULL,0,NULL,NULL),(14,'admin',NULL,'$2b$08$mwf94C17PtWDoz7u/uGYEeKRFbtg.1D05fa78MmZSVsQUTdRg58d.','2025-10-14 15:36:16',72,NULL,72,1,NULL,NULL),(15,'username10',NULL,'$2b$08$G70N7uhoqQlj/P5ulaQvd.r/BwkE88UmC2RE3JUUxkrv3M/Sx6Hze','2025-10-14 15:36:19',400,NULL,400,0,NULL,NULL);
...
-- Dump completed on 2026-04-14  1:30:50

-- --- Migration gợi ý (nếu DB cũ còn bảng contests có cột `grade_id` + UNIQUE khối) ---
-- ALTER TABLE contests DROP INDEX week_start;
-- ALTER TABLE contests DROP FOREIGN KEY contests_ibfk_1;  -- tên FK có thể khác; kiểm tra INFORMATION_SCHEMA
-- ALTER TABLE contests DROP COLUMN grade_id;
-- Sau đó thêm cột name, prize nếu thiếu (khớp CREATE TABLE phía trên).
