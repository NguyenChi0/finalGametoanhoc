...
INSERT INTO `grades` VALUES (1,'Lớp 1',NULL),(2,'Lớp 2',NULL),(3,'Lớp 3',NULL),(4,'Lớp 4',NULL),(5,'Lớp 5',NULL);
...
DROP TABLE IF EXISTS `weekly_exams`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `weekly_exams` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `week_start` (`week_start`,`grade_id`),
  KEY `grade_id` (`grade_id`),
  KEY `template_id` (`template_id`),
  CONSTRAINT `weekly_exams_ibfk_1` FOREIGN KEY (`grade_id`) REFERENCES `grades` (`id`),
  CONSTRAINT `weekly_exams_ibfk_2` FOREIGN KEY (`template_id`) REFERENCES `exam_templates` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `weekly_exams`
--

LOCK TABLES `weekly_exams` WRITE;
/*!40000 ALTER TABLE `weekly_exams` DISABLE KEYS */;
/*!40000 ALTER TABLE `weekly_exams` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-04-12  7:02:08
