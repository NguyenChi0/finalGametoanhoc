    ...
    <div style={{ position: "relative", minHeight: "100vh" }}>
      ...
      <style>{`
        ...
        .shop-frame {
          ...
          min-height: 380px;
          background-image: url(${publicUrl}/component-images/shop.png);
        ...
        @media (max-width: 768px) {
          ...
          .shop-frame {
            ...
            background-image: url(${publicUrl}/component-images/shop_mobile.png) !important;
      ...
      <div className="shop-frame">
        <div className="shop-header-block">
          <h2 style={{ marginTop: 0, marginBottom: 8, color: "#0B79B4", fontSize: "1.25rem" }}>
            🛍️ Cửa hàng vật phẩm
          </h2>
